...
CUSTOM_HAL_IMGSENSOR = s5kjn1sunny_mipi_raw ov50c40ofilm_mipi_raw ov16a1qofilm_mipi_raw ov16a1qqtech_mipi_raw imx355ofilm_mipi_raw imx355sunny_mipi_raw
CUSTOM_HAL_MAIN2_IMGSENSOR = imx355ofilm_mipi_raw
CUSTOM_HAL_MAIN_IMGSENSOR = s5kjn1sunny_mipi_raw ov50c40ofilm_mipi_raw
CUSTOM_HAL_MSENSORLIB = akm
CUSTOM_HAL_SENSORS = sensor
CUSTOM_HAL_SUB_IMGSENSOR = ov16a1qofilm_mipi_raw ov16a1qqtech_mipi_raw
...
CUSTOM_KERNEL_IMGSENSOR = s5kjn1sunny_mipi_raw ov50c40ofilm_mipi_raw ov16a1qofilm_mipi_raw ov16a1qqtech_mipi_raw imx355ofilm_mipi_raw imx355sunny_mipi_raw
...
CUSTOM_KERNEL_MAIN_IMGSENSOR = s5kjn1sunny_mipi_raw ov50c40ofilm_mipi_raw
...
CUSTOM_KERNEL_SUB_IMGSENSOR = ov16a1qofilm_mipi_raw ov16a1qqtech_mipi_raw
...
MTK_BWC_SUPPORT = yes
#HONGMI-89017,jinguozhi.wt,modify,20210730,disable C2K,start
MTK_C2K_LTE_MODE = 0
MTK_MD1_SUPPORT = 22
MTK_PROTOCOL1_RAT_CONFIG = N/Lf/Lt/W/G

ifeq ($(WT_COMPILE_FACTORY_VERSION), yes)
$(warning WT_COMPILE_FACTORY_VERSION=yes)
MTK_C2K_LTE_MODE = 2
MTK_MD1_SUPPORT = 25
...
$(warning MIUI_BUILD_REGION=CN)
MTK_C2K_LTE_MODE = 2
MTK_MD1_SUPPORT = 25
MTK_PROTOCOL1_RAT_CONFIG = N/C/Lf/Lt/W/G
endif
#HONGMI-89017,jinguozhi.wt,modify,20210730,disable C2K,end
...
# Bsp.audio for vow
ifeq ($(MIUI_BUILD_SUPPORT_REGION),in) # k16A poco for okgoogle
    ##$(info 'vow debug: region in')
    ...
    ##$(info 'vow debug: region cn for xiaoaitongxue')
    MTK_VOW_AMAZON_SUPPORT = no
...
# +HONGMI-87692, zhouyaru.wt, modify, 20210712, for cts test
...
NAND_OTP_SUPPORT = no
#+bug 665876, huxiaolin.wt, modify, 2021.07.08, for CT Register
ifneq (,$(filter $(MIUI_CURRENT_CUST_VARIANT), cn cn_chinatelecom))
OPTR_SPEC_SEG_DEF = OP09_SPEC0212_SEGC
else ifeq ($(PRODUCT_BUILD_CUSTOMIZATION_TEST),ct)
OPTR_SPEC_SEG_DEF = OP09_SPEC0212_SEGC
else
...
#+ExtBUG HONGMI-84996 fangxianpeng modify 20210517 sarfeature config
...
#+bug651594, zhouweijie.wt, add, 20210611, add spk ap swmix process for sia81xx
ifeq ($(WT_COMPILE_FACTORY_VERSION), yes)
MTK_SPK_AP_SWMIX_PROCESS = no
else
MTK_SPK_AP_SWMIX_PROCESS = yes
endif
#-bug651594, zhouweijie.wt, add, 20210611, add spk ap swmix process for sia81xx
MTK_CAM_SINGLE_NR_SUPPORT = yes
MTK_TOUCHPANEL_KO =
MTK_FAST_CHARGER_TECH = no
WT_INNER_VERSION=SW_evergo
WT_PRODUCTION_VERSION=CUST_evergo
NFC_CHIP_SUPPORT=no
ifeq ($(WT_COMPILE_FACTORY_VERSION), yes)
FACTORY_BUILD = 1
$(warning FACTORY_BUILD = 1)
endif
